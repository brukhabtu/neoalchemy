...
from neoalchemy.models import Node, Relationship, Neo4jModel
from neoalchemy.expressions import FieldExpr
from neoalchemy import initialize
from tests.test_utils import ModelTestHelper, isolated_registry
...
class TestModelBasics:
    ...
    def test_neo4j_model_uuid_serialization(self):
        ...
        model = TestModel(id=test_id, items=[test_item_id])
