...
class Account(SourcedNode):
    ...
    account_id: Optional[str] = Field(
        default=None, 
        unique=True, 
        description="Service-specific ID (unique identifier)"
    )
...
class ConfluenceEntity(SourcedNode):
    ...
    confluence_id: str = Field(unique=True, description="Confluence's internal ID (unique identifier)")
...
class ConfluenceSpace(ConfluenceEntity):
    ...
    type: str = Field(default="global", index=True, description="Space type (global, personal, etc.)")
...
class ConfluencePage(ConfluenceEntity):
    ...
    last_modifier_username: Optional[str] = Field(default=None, index=True, description="Username of last modifier")
...
class ConfluenceComment(ConfluenceEntity):
    ...
    parent_comment_id: Optional[str] = Field(default=None, index=True, description="Parent comment ID")
...
class HAS_ACCOUNT(SourcedRelationship):
    ...
    is_primary: bool = Field(default=False, index=True, description="Whether this is the primary account")
